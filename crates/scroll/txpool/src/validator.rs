...
use reth_scroll_evm::{
    compute_compression_factor, spec_id_at_timestamp_and_number, RethL1BlockInfo,
};
    ...
    Tx: EthPoolTransaction,
{
    ...
    pub fn validate_one(
        ...
        } = outcome
        {
            ...
            let compression_factor = compute_compression_factor(&encoded);
