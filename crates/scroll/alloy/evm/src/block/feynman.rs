...
const FEYNMAN_L1_GAS_PRICE_ORACLE_STORAGE: [(U256, U256); 3] = [
    (GPO_PENALTY_THRESHOLD_SLOT, INITIAL_PENALTY_THRESHOLD),
    (GPO_PENALTY_FACTOR_SLOT, INITIAL_PENALTY_FACTOR),
    (GPO_IS_FEYNMAN_SLOT, IS_FEYNMAN),
];
...
mod tests {
    use super::*;
    use crate::curie::CURIE_L1_GAS_PRICE_ORACLE_BYTECODE;
    use revm::{
        database::{
