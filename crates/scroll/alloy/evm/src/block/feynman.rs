...
pub use super::curie::L1_GAS_PRICE_ORACLE_ADDRESS;
...
pub const INITIAL_PENALTY_THRESHOLD: U256 = U256::from_limbs([1_000_000_000, 0, 0, 0]);
/// The initial compression penalty factor used by the oracle contract.
pub const INITIAL_PENALTY_FACTOR: U256 = U256::from_limbs([1_000_000_000, 0, 0, 0]);
/// Feynman slot is set to 1 (true) after the Feynman block fork.
pub const IS_FEYNMAN: U256 = U256::from_limbs([1, 0, 0, 0]);

/// Storage update of L1 gas price oracle at Feynman transition.
pub const FEYNMAN_L1_GAS_PRICE_ORACLE_STORAGE: [(U256, U256); 3] = [
