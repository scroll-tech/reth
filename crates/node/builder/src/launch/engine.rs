...
impl EngineNodeLauncher {
    ...
    where
        ...
        <AO as reth_node_api::NodeAddOns<NodeAdapter<T, CB::Components>>>::Handle:
            RpcHandleProvider<
                NodeAdapter<T, CB::Components>,
                <AO as RethRpcAddOns<NodeAdapter<T, CB::Components>>>::EthApi,
            >,
    {
        ...
        let engine_events_for_ethstats = event_sender.new_listener();
        ...
        let full_node = FullNode {
            ...
            add_ons_handle: addons_handle.clone(),
        };
